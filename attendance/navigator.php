...
<!--                        <li class="nav-item">
                        ...
                        <a class="dropdown-item" href="login.php"></a></li>'); 
                                } else {
                                        echo ('   
                                <li class="nav-item dropdown">          
                            <a class="nav-link link dropdown-toggle" data-toggle="dropdown-submenu" href = "">☻☻☻</a>
                            <div class="dropdown-menu">  
                            <a class="dropdown-item" href="createEvent.php?Set Event">Set Event</a>
